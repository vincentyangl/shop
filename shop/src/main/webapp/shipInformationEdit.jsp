...
<body>
	...
	<div class="larry-personal">
		<header class="larry-personal-tit"> <span>发货人信息修改</span> </header>
		<!-- /header -->
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" method="post"
				action="/consignor/updateById">
				<input type="hidden" name="shipId" value="${si.shipId }">
				<div class="layui-form-item">
					<label class="layui-form-label">发货人</label>
					<div class="layui-input-block">
						<input type="text" name="shipName" autocomplete="off"
							class="layui-input" value="${si.shipName }">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">发货人联系方式</label>
					<div class="layui-input-block">
						<input type="text" name="shipPhoneNum" autocomplete="off"
							class="layui-input" value="${si.shipPhoneNum }">
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="shipSite" autocomplete="off"
							class="layui-input" value="${si.shipSite }">
					</div>
				</div>
				<div class="layui-form-item">
