                ...
                <div class="layui-tab-item layui-field-box layui-show">
                     <table class="layui-table table-hover" lay-even="" lay-skin="nob">
                          ...
                          <c:forEach items="${users }" var="u" varStatus="statu">
                              <tr>
                                <td><input type="checkbox" value="${u.user_id }"></td>
                                <td>${statu.index+1 }</td>
                                <td>${u.user_name }</td>
                                <td>${u.role.role_name }</td>
                                <td><a href="/user/delete/${u.user_id }" class="btn btn-default ">删除</a><a href="/ProductServlet?state=toUpdate&pid=${p.pid}" class="btn btn-default">修改</a></td>
                              </tr>
                              </c:forEach>
                          </tbody>
                     </table>
